...
def result1():
    ...
    query_job = bigquery_client.query(
        ...
        FROM `a1_2.gsquarterlySeptember20` 
...
def result2():
    ...
    query_job = bigquery_client.query(
        ...
        inner join `a1_2.country_classification` b
...
def result3():
    ...
    query_job = bigquery_client.query(
        ...
        from `a1_2.gsquarterlySeptember20` a
        inner join `a1_2.services_classification` b on a.code=b.code
        where a.time_ref in 
        (
            SELECT time_ref
            FROM `a1_2.gsquarterlySeptember20` 
